let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    const buttons = [
        ...
        { buttonId: '.6', buttonText: { displayText: '⌬ ❛╏الالعاب' }, type: 1 },
        { buttonId: '.6', buttonText: { displayText: '⌬ ❛╏الترفيه' }, type: 1 },
        { buttonId: '.2', buttonText: { displayText: '⌬ ❛╏الصور' }, type: 1 },
        { buttonId: '.20', buttonText: { displayText: '⌬ ❛╏شروط' }, type: 1 },
        { buttonId: '.الدعم', buttonText: { displayText: '⌬ ❛╏الدعم' }, type: 1 },
        { buttonId: '.10', buttonText: { displayText: '⌬ ❛╏قائمة الاوامر' }, type: 1 },
    ];
