...
● *لتفهم البوت اكتب《 .اوامر 》*

● *نتمني ان يعجبك الجروب*
...
● *_ف داهيه مترجعش تاني كدا كدا مكنش ليك لازمه_*

~*⊹‏⊱≼━━━⌬〔 𝒁𝒆𝒛𝒐 𝑩𝒐𝒕 〕⌬━━━≽⊰⊹*~`;
  conn.spromote = '*[ 📌 ] @user تمت ترقيته إلى المسؤول اللي رقاك '@'[m.sender]*';
  conn.sdemote = '*[ 📌 ] @user تم تخفيض رتبته من المسؤول اللي شالك '@'[m.sender]*';
